  ...
  <b-list-group class="listGroup thin-scroll">
    <b-list-group-item class="listGroupItem bg-attention">
      ...
      <p class="m-0 overflow-hidden">
        ...
        &nbsp;<a href="#">Approvals</a> completed on time
    ...
    <b-list-group-item class="listGroupItem bg-attention">
      ...
      <p class="m-0 overflow-hidden">
        <a href="#">Jeniffer Willington</a> created new Material Event
        <time class="help-block m-0">
          30 sec ago
        </time>
      </p>
    ...
    <b-list-group-item class="listGroupItem">
      ...
      <p class="text-ellipsis m-0 overflow-hidden">
        Daily Post completed with warnings
        <time class="help-block m-0">
          7h ago
        </time>
      </p>
    ...
    <b-list-group-item class="listGroupItem">
      ...
      <p class="m-0 overflow-hidden">
        Instructions for changing your DVS Account passwor <a href="#">security page</a>.
        <time class="help-block m-0">
          12:18 AM
        </time>
      </p>
